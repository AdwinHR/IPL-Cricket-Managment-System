...
public class Q2 extends JInternalFrame {
	 ...
	 */
	public Q2() {
		setTitle("Qualifier 2");
		getContentPane().setBackground(Color.WHITE);
		setClosable(true);
		setBounds(100, 100, 952, 378);
		getContentPane().setLayout(null);
		
		JLabel lblQualifier = new JLabel("Qualifier 2");
		...
		try {
			String Q1="select tid,result from game_played where matchid=58";
