...
public class Q3 extends JInternalFrame {
	 ...
	 */
	public Q3() {
		setTitle("Qualifier 3");
		getContentPane().setBackground(Color.WHITE);
		setClosable(true);
		setBounds(100, 100, 952, 378);
		getContentPane().setLayout(null);
		
		JLabel lblQualifier = new JLabel("Qualifier 3");
		...
		try {
		String Q1="select tid,result from game_played where matchid=59";
