...
public class Q1 extends JInternalFrame {
	 ...
	 */
	public Q1() {
		setTitle("Qualifier 1");
		getContentPane().setBackground(Color.WHITE);
		setClosable(true);
		setBounds(100, 100, 952, 378);
		getContentPane().setLayout(null);
		
		JLabel lblQualifier = new JLabel("Qualifier 1");
		...
		l3.setBounds(329, 215, 535, 47);
		getContentPane().add(l3);
		
		try {
		String Q1="select tid,result from game_played where matchid=57";
