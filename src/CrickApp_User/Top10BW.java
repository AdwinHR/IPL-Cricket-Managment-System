...
public class Top10BW extends JInternalFrame {
	...
	public Top10BW() {
		...
		try {
			...
			textFields1.setText(Integer.toString(s[b[1]]));
			
			textFieldn2.setText(n[b[2]]);
			textFields2.setText(Integer.toString(s[b[2]]));
			
			textFieldn3.setText(n[b[3]]);
			textFields3.setText(Integer.toString(s[b[3]]));
			
			textFieldn4.setText(n[b[4]]);
			textFields4.setText(Integer.toString(s[b[4]]));
			
			textFieldn5.setText(n[b[5]]);
			textFields5.setText(Integer.toString(s[b[5]]));
			
			textFieldn6.setText(n[b[6]]);
			textFields6.setText(Integer.toString(s[b[6]]));
			
			textFieldn7.setText(n[b[7]]);
			textFields7.setText(Integer.toString(s[b[7]]));
			
			textFieldn8.setText(n[b[8]]);
			textFields8.setText(Integer.toString(s[b[8]]));
			
			textFieldn9.setText(n[b[9]]);
			textFields9.setText(Integer.toString(s[b[9]]));
			
			textFieldn10.setText(n[b[10]]);
			textFields10.setText(Integer.toString(s[b[10]]));
